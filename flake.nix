  ...
  outputs = { self, nixpkgs, flake-utils }:
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        luajit = pkgs.stdenv.mkDerivation {
          ...
          src = pkgs.fetchgit {
            ...
            rev = "1ee778a4e37122d8ca7d5733c590a47dafd6b15c";
            sha256 = "sha256-UJurgBtfjqc5Uwff3uOF0DMRkLqzxU15yeniUe8r8/E=";
          };
      ...
      in
      {
        ...
        # CI shell uses lavapipe (software Vulkan) for reproducible headless runs
