...
function line.CreateLoveEnv(version)
	...
	line.LoadLoveLibrary(love, "addons/love/lua/libraries/arg.lua")
	love._modules.arg = true
	line.LoadLoveLibrary(love, "addons/love/lua/libraries/event.lua")
	love._modules.event = true
	line.LoadLoveLibrary(love, "addons/love/lua/libraries/graphics.lua")
	love._modules.graphics = true
	line.LoadLoveLibrary(love, "addons/love/lua/libraries/joystick.lua")
	love._modules.joystick = true
	line.LoadLoveLibrary(love, "addons/love/lua/libraries/love.lua")
	line.LoadLoveLibrary(love, "addons/love/lua/libraries/mouse.lua")
	love._modules.mouse = true
	line.LoadLoveLibrary(love, "addons/love/lua/libraries/physics.lua")
	love._modules.physics = true
	line.LoadLoveLibrary(love, "addons/love/lua/libraries/system.lua")
	love._modules.system = true
	line.LoadLoveLibrary(love, "addons/love/lua/libraries/timer.lua")
	love._modules.timer = true
	line.LoadLoveLibrary(love, "addons/love/lua/libraries/audio.lua")
	love._modules.audio = true
	line.LoadLoveLibrary(love, "addons/love/lua/libraries/filesystem.lua")
	love._modules.filesystem = true
	line.LoadLoveLibrary(love, "addons/love/lua/libraries/data.lua")
	love._modules.data = true
	line.LoadLoveLibrary(love, "addons/love/lua/libraries/image_data.lua")
	love._modules.image = true
	line.LoadLoveLibrary(love, "addons/love/lua/libraries/keyboard.lua")
	love._modules.keyboard = true
	line.LoadLoveLibrary(love, "addons/love/lua/libraries/math.lua")
	love._modules.math = true
	line.LoadLoveLibrary(love, "addons/love/lua/libraries/particles.lua")
	love._modules.particles = true
	line.LoadLoveLibrary(love, "addons/love/lua/libraries/sound.lua")
	love._modules.sound = true
	line.LoadLoveLibrary(love, "addons/love/lua/libraries/thread.lua")
	love._modules.thread = true
	line.LoadLoveLibrary(love, "addons/love/lua/libraries/window.lua")
...
function line.RunGame(folder, ...)
	...
	local vendored_luasocket_modules = {
		...
		["socket.core"] = "addons/love/lua/libraries/socket_core.lua",
