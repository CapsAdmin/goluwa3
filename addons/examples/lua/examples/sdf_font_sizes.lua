...
-- Each font baked at its target size for optimal SDF quality
local font8 = fonts.New{Path = fontPath, Size = 8}
local font12 = fonts.New{Path = fontPath, Size = 12}
local font16 = fonts.New{Path = fontPath, Size = 16}
local font24 = fonts.New{Path = fontPath, Size = 24}
local font36 = fonts.New{Path = fontPath, Size = 36}
local font48 = fonts.New{Path = fontPath, Size = 48}
local font72 = fonts.New{Path = fontPath, Size = 72}
local font128 = fonts.New{Path = fontPath, Size = 128}
...
event.AddListener("Draw2D", "sdf_font_sizes", function()
	...
	render2d.SetColor(1, 1, 1, 1)
	drawSizeLabel("8", x, y)
	font8:DrawText(sampleText, x + 50, y + 2)
	y = y + 25
	-- 12px
	drawSizeLabel("12", x, y)
	font12:DrawText(sampleText, x + 50, y + 2)
	y = y + 30
	-- 16px
	drawSizeLabel("16", x, y)
	font16:DrawText(sampleText, x + 50, y + 2)
	y = y + 35
	-- 24px
	drawSizeLabel("24", x, y)
	font24:DrawText(sampleText, x + 50, y + 2)
	y = y + 45
	-- 36px
	drawSizeLabel("36", x, y)
	font36:DrawText(sampleText, x + 50, y + 2)
	y = y + 60
	-- 48px
	drawSizeLabel("48", x, y)
	font48:DrawText(sampleText, x + 50, y + 2)
	y = y + 75
	-- 72px
	drawSizeLabel("72", x, y)
	font72:DrawText(shortText, x + 50, y + 2)
	y = y + 75
	-- ============================================================
	...
	font16:DrawText("SDF Threshold (thickness):", x, y)
	y = y + 25
	...
	for i, thresh in ipairs(thresholds) do
		...
		render2d.SetColor(1, 1, 1, 1)
		font48:DrawText("SDF", x + (i - 1) * 100, y)
		render2d.PopSDFThreshold()
		render2d.PopBlur()
		render2d.SetColor(0.5, 0.5, 0.5, 1)
		font12:DrawText(string.format("%.1f", thresh), x + (i - 1) * 100 + 10, y + 15)
	end

	y = y + 70
	-- SDF softness comparison
	render2d.SetColor(0.6, 0.6, 0.6, 1)
	font16:DrawText("SDF Softness (blur):", x, y)
	y = y + 25
	...
	for i, soft in ipairs(softnesses) do
		...
		render2d.PopBlur()
		render2d.SetColor(0.5, 0.5, 0.5, 1)
		font12:DrawText(tostring(soft), x + (i - 1) * 100 + 20, y + 15)
	end

	y = y + 70
	-- SDF gamma comparison
	render2d.SetColor(0.6, 0.6, 0.6, 1)
	font16:DrawText("SDF Gamma:", x, y)
	y = y + 25
	...
	for i, gamma in ipairs(gammas) do
		...
		render2d.PopBlur()
		render2d.SetColor(0.5, 0.5, 0.5, 1)
		font12:DrawText(string.format("%.1f", gamma), x + (i - 1) * 100 + 10, y + 15)
	end

	y = y + 70
	-- SDF bias comparison
	render2d.SetColor(0.6, 0.6, 0.6, 1)
	font16:DrawText("SDF Bias:", x, y)
	y = y + 25
	...
	for i, bias in ipairs(biases) do
		...
		render2d.PopBlur()
		render2d.SetColor(0.5, 0.5, 0.5, 1)
		font12:DrawText(string.format("%.2f", bias), x + (i - 1) * 100 + 10, y + 15)
	end

	y = y + 70
	-- Combined effects with animation
	render2d.SetColor(0.6, 0.6, 0.6, 1)
	font16:DrawText("Animated SDF (threshold + softness + gamma):", x, y)
	y = y + 25
	...
	render2d.SetColor(0.6, 0.6, 0.6, 1)
	font16:DrawText("Filled Circles (SDF-enabled):", x, y)
	y = y + 25
	...
	-- Outlined circles
	render2d.SetColor(0.6, 0.6, 0.6, 1)
	font16:DrawText("Outlined Circles:", x, y)
	y = y + 25
	...
	render2d.SetColor(0.6, 0.6, 0.6, 1)
	font16:DrawText("Rounded Rectangles (SDF border radius):", x, y)
	y = y + 25
	...
	render2d.SetColor(0.6, 0.6, 0.6, 1)
	font16:DrawText("Rectangles with Outline (SDF):", x, y)
	y = y + 25
	...
	render2d.SetColor(0.6, 0.6, 0.6, 1)
	font16:DrawText("Lines (varying thickness):", x, y)
	y = y + 25
