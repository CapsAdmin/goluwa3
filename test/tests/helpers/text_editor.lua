...
T.Test("text_editor selection", function()
	local editor = text_editor.New("hello world")
	editor.Cursor = 1
...
T.Test("text_editor multiline", function()
	local editor = text_editor.New("line 1\nline 2\nline 3")
	editor.Cursor = 10
...
T.Test("text_editor word movement", function()
	local editor = text_editor.New("hello world  test")
	editor.Cursor = 1
...
T.Test("text_editor ctrl movement", function()
	local editor = text_editor.New("hello world test")
	editor.Cursor = 1
...
T.Test("text_editor ctrl backspace", function()
	local editor = text_editor.New("hello world test")
...
T.Test("text_editor home end", function()
	local editor = text_editor.New("line one\nline two")
...
T.Test("text_editor selection with shift", function()
	local editor = text_editor.New("hello world")
	editor.Cursor = 1
...
T.Test("text_editor undo", function()
...
T.Test("text_editor page up down", function()
	...
	local editor = text_editor.New(text)
...
T.Test("text_editor ctrl delete", function()
	local editor = text_editor.New("hello world test")
	editor.Cursor = 1
	editor:SetControlDown(true)
...
T.Test("text_editor select word/line", function()
	local editor = text_editor.New("hello world test")
	...
	T(start)["=="](7)
	T(stop)["=="](12) -- "world"
	editor = text_editor.New("line one\nline two")
	editor.Cursor = 5 -- "line| one"
	editor:SelectLine()
...
T.Test("text_editor duplicate line", function()
	local editor = text_editor.New("hello\nworld")
	editor.Cursor = 1
	editor:SetControlDown(true)
	editor:OnKeyInput("d")
...
T.Test("text_editor clipboard", function()
	local editor = text_editor.New("hello world")
...
T.Test("text_editor wrapping", function()
	local editor = text_editor.New("1234567890")
...
T.Test("text_editor wrapping edge cases", function()
	local editor = text_editor.New("1234567890123")
	editor:SetWrapWidth(5)
	-- [[
	-- 12345 (1)
	-- 67890 (2)
