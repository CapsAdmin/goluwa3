...
T.Test("culling behavior", function()
	render.Initialize({headless = true, width = width, height = height})
	render3d.Initialize()
	-- Setup a sun light so we can see stuff
	ecs.CreateFromTable(
		{
			[transform] = {},
			[light] = {
	...
	T.Test("Object directly in front should not be culled", function()
	...
	T.Test("Object behind should be culled", function()
	...
	T.Test("Object far left outside frustum should be culled", function()
	...
	T.Test("Object partially inside from the left should not be culled", function()
	...
	T.Test("Object beyond FarZ should be culled", function()
	...
	T.Test("Object closer than NearZ should be culled", function()
	...
	T.Test("Culling with rotated camera", function()
	...
	T.Test("Freezing culling", function()
		local ent, mdl = spawn_test_object(Vec3(0, 0, -5), 1, Color(1, 0, 0))
	...
	T.Test("Near plane clipping reproduction (from camera.lua)", function()
		-- Setup camera
		local cam = render3d.GetCamera()
	...
	T.Test("Far plane clipping reproduction (from camera.lua)", function()
		-- Setup camera
		local cam = render3d.GetCamera()
		cam:SetPosition(Vec3(0, 0, 0))
		cam:SetFarZ(9.9)
	...
	T.Test("Movement left reproduction (from camera.lua)", function()
	...
	T.Test("Movement backward reproduction", function()
