...
T.Test("Graphics Polygon3D render simple triangle", function()
	draw3d(function(cmd)
		...
		local mat = Material.New({base_color_factor = Color(1.0, 0.0, 0.0, 1.0)})
...
T.Test("Graphics Polygon3D render cube", function()
	draw3d(function(cmd)
		...
		local mat = Material.New({base_color_factor = Color(0.0, 1.0, 0.0, 1.0)})
		render3d.SetMaterial(mat)
		render3d.UploadConstants(cmd)
		poly:Draw(cmd)
	end)
...
T.Test("Graphics Polygon3D render with world matrix", function()
	draw3d(function(cmd)
		...
		local mat = Material.New({base_color_factor = Color(0.0, 0.0, 1.0, 1.0)})
		render3d.SetMaterial(mat)
		render3d.UploadConstants(cmd)
		poly:Draw(cmd)
		-- Reset world matrix
...
T.Test("Graphics Polygon3D render multiple objects", function()
	draw3d(function(cmd)
		...
		local mat1 = Material.New({base_color_factor = Color(1.0, 0.0, 0.0, 1.0)})
		render3d.SetMaterial(mat1)
		render3d.UploadConstants(cmd)
		poly1:Draw(cmd)
		-- Draw second with blue material
		local mat2 = Material.New({base_color_factor = Color(0.0, 0.0, 1.0, 1.0)})
