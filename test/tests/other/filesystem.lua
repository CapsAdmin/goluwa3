...
T.Test("filesystem shared path utility helpers", function()
	T(file_path.Normalize("a/./b/../c//"))["=="]("a/c")
	T(file_path.FixPathSlashes("a\\b///c"))["=="]("a/b/c")
	T(file_path.TrimTrailingPathSeparator("a/b/c/"))["=="]("a/b/c")
	T(file_path.TrimTrailingPathSeparator("/"))["=="]("/")
	T(file_path.GetParentDirectoryFromPath("a/b/c"))["=="]("a/b")
	T(file_path.GetParentDirectoryFromPath("a/b/c/"))["=="]("a/b")
	T(file_path.GetParentDirectoryFromPath("file.txt"))["=="](".")
	T(file_path.GetParentDirectoryFromPath("/"))["=="](nil)
	T(file_path.GetParentFolderFromPath("a/b/c.txt"))["=="]("a/")
	T(file_path.GetFolderNameFromPath("a/b/c/"))["=="]("c")
	T(file_path.GetFileNameFromPath("a/b/c.txt"))["=="]("c.txt")
	T(file_path.RemoveExtensionFromPath("a/b/c.txt"))["=="]("a/b/c")
