...
T.Test("orientation vectors are normalized", function()
	...
	T(vec_length(orientation.UP_VECTOR))["~"](1)
	T(vec_length(orientation.RIGHT_VECTOR))["~"](1)
	T(vec_length(orientation.FORWARD_VECTOR))["~"](1)
end)
...
T.Test("Ang3 GetUp/Right/Forward at zero rotation", function()
	T(Ang3(0, 0, 0):GetUp())["=="](Vec3(unpack(orientation.UP_VECTOR)))
	T(Ang3(0, 0, 0):GetRight())["=="](Vec3(unpack(orientation.RIGHT_VECTOR)))
	T(Ang3(0, 0, 0):GetForward())["=="](Vec3(unpack(orientation.FORWARD_VECTOR)))
end)

T.Test("Quat directional methods use orientation module", function()
	T(Quat():GetUp())["=="](Vec3(unpack(orientation.UP_VECTOR)))
	T(Quat():GetRight())["=="](Vec3(unpack(orientation.RIGHT_VECTOR)))
	T(Quat():GetForward())["=="](Vec3(unpack(orientation.FORWARD_VECTOR)))
end)

T.Test("Ang3 GetDirection transforms vectors", function()
	T(Ang3(0, 0, 0):GetDirection(orientation.GetRightVector()))["=="](Vec3(unpack(orientation.RIGHT_VECTOR)))
end)
