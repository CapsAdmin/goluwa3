...
T.Test3D("Compound mesh builder splits disconnected triangle islands", function()
	local compound = physics.BuildCompoundShapeFromTriangles(create_split_box_mesh())
	T(compound ~= nil)["=="](true)
...
T.Test3D("Static compound collider preserves concave gap from generated child hulls", function()
	...
	local compound_desc = physics.BuildCompoundShapeFromTriangles(create_split_box_mesh())
