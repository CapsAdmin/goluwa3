...
T.TestPhysics("Kinematic controller moves body along flat ground", function()
...
T.TestPhysics("Kinematic controller supports capsule bodies on flat ground", function()
...
T.TestPhysics("Kinematic capsule ground speed matches desired velocity", function()
...
T.TestPhysics("Kinematic controller capsule can stand on static box", function()
...
T.TestPhysics("Physics body lands on ground mesh", function()
...
T.TestPhysics("Kinematic body can stand on rigid body", function()
...
T.TestPhysics("Kinematic capsule is carried by moving rigid body platform", function()
...
T.TestPhysics("Kinematic capsule follows walkable slopes", function()
...
T.TestPhysics("Kinematic capsule does not get launched downhill while idle on slopes", function()
...
T.TestPhysics("Kinematic capsule walks down low ledges", function()
...
T.TestPhysics("Kinematic capsule can walk off tall ledges and fall", function()
...
T.TestPhysics("Kinematic capsule can jump from flat ground", function()
