...
T.TestPhysics("Rigid sphere does not perch unrealistically on box edge", function()
...
T.TestPhysics("Rigid box can rest on static box", function()
...
T.TestPhysics("Rigid resting contact stays stable over time", function()
...
T.TestPhysics("Rigid sphere rolls off rotated box instead of resting on its AABB", function()
