...
T.Test("layout - child self alignment overrides parent cross axis", function()
	local parent = NewBox("Parent", Vec2(200, 200))
	parent:AddComponent("layout")
	parent.layout:SetDirection("y")
	parent.layout:SetAlignmentX("start")
	local child = NewBox("Child", Vec2(50, 50))
	child:SetParent(parent)
	child:AddComponent("layout")
	child.layout:SetSelfAlignmentX("center")
	parent.layout:UpdateLayout()
	T(child.transform:GetX())["=="](75)
	T(child.transform:GetWidth())["=="](50)
	parent:Remove()
end)

T.Test("layout - child self alignment can stretch on cross axis", function()
	local parent = NewBox("Parent", Vec2(200, 200))
	parent:AddComponent("layout")
	parent.layout:SetDirection("y")
	parent.layout:SetAlignmentX("start")
	...
	child:SetParent(parent)
	child:AddComponent("layout")
	child.layout:SetSelfAlignmentX("stretch")
	parent.layout:UpdateLayout()
