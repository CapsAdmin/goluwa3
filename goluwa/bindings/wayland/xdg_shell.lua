...
do
	...
	function meta:set_fullscreen(...)
		...
		if has_new_id then
			...
			elseif new_id_interface then
				local target_interface = ffi.cast("struct wl_interface*", interface_ptrs[new_id_interface])
				local new_proxy = ffi.C.wl_proxy_marshal_array_constructor(ffi.cast("struct wl_proxy*", self), 11, args_array, target_interface)
				return ffi.cast("struct " .. new_id_interface .. "*", new_proxy)
			end
		else
	...
	function meta:unset_fullscreen(...)
		...
		if has_new_id then
			...
			elseif new_id_interface then
				local target_interface = ffi.cast("struct wl_interface*", interface_ptrs[new_id_interface])
				local new_proxy = ffi.C.wl_proxy_marshal_array_constructor(ffi.cast("struct wl_proxy*", self), 12, args_array, target_interface)
				return ffi.cast("struct " .. new_id_interface .. "*", new_proxy)
			end
		else
	...
	function meta:set_minimized(...)
		...
		if has_new_id then
			...
			elseif new_id_interface then
				local target_interface = ffi.cast("struct wl_interface*", interface_ptrs[new_id_interface])
				local new_proxy = ffi.C.wl_proxy_marshal_array_constructor(ffi.cast("struct wl_proxy*", self), 13, args_array, target_interface)
				return ffi.cast("struct " .. new_id_interface .. "*", new_proxy)
			end
		else
