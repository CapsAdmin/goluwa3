...
function WebSocketClient:Send(message, opcode)
...
function WebSocketClient.New()
	local self = WebSocketClient:CreateObject()
	self.socket = TCPClient.New()
