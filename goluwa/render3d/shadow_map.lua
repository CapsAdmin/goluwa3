...
local DEFAULT_DIRECTIONAL_PROJECTION_MODE = "lispsm"
...
local function update_local_directional_lispsm(self, light_position, light_rotation, range)
...
function ShadowMap:UpdateLocalDirectionalLightMatrices(light_position, light_rotation, range, ortho_size)
	if
		self.directional_projection_mode == "lispsm" and
		update_local_directional_lispsm(self, light_position, light_rotation, range)
	then
		return
	end
