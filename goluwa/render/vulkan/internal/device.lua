...
function Device.New(physical_device, extensions, graphicsQueueFamily)
	...
	-- Note: VK_EXT_scalar_block_layout was promoted to Vulkan 1.2
	-- The scalarBlockLayout feature is now enabled via VkPhysicalDeviceVulkan12Features
	-- We should NOT add VkPhysicalDeviceScalarBlockLayoutFeaturesEXT to the pNext chain
	-- when using VkPhysicalDeviceVulkan12Features as they conflict
