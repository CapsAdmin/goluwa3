...
META:StartStorable()
META:StartOptions({callback = "OnTextChanged"})
META:GetSet("Font", nil)
META:GetSet("FontSize", 14)
META:GetSet("Text", "")
META:GetSet("Wrap", false)
META:GetSet("WrapToParent", false)
META:GetSet("Elide", false)
META:GetSet("Justify", false)
META:GetSet("ElideString", "...")
META:GetSet("AlignX", 0)
META:GetSet("AlignY", 0)
META:EndOptions()
META:GetSet("Hint", "")
