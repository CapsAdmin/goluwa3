		...
		do -- device
			...
			do -- render pass
				...
				function Device:CreateRenderPass(surfaceFormat, samples, final_layout, depth_format)
					...
					local depthAttachmentRef = has_depth and T.Box(
						vk.VkAttachmentReference,
						{
					...
					local dependency = T.Box(
						vk.VkSubpassDependency,
						{
							...
							srcStageMask = has_depth and
								bit.bor(vk.VkPipelineStageFlagBits("VK_PIPELINE_STAGE_COLOR_ATTACHMENT_OUTPUT_BIT"), vk.VkPipelineStageFlagBits("VK_PIPELINE_STAGE_EARLY_FRAGMENT_TESTS_BIT")) or
								vk.VkPipelineStageFlagBits("VK_PIPELINE_STAGE_COLOR_ATTACHMENT_OUTPUT_BIT"),
							srcAccessMask = 0,
							...
							dstAccessMask = has_depth and
								bit.bor(vk.VkAccessFlagBits("VK_ACCESS_COLOR_ATTACHMENT_WRITE_BIT"), vk.VkAccessFlagBits("VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_WRITE_BIT")) or
			...
			do -- framebuffer
				...
				function Device:CreateFramebuffer(renderPass, imageView, width, height, msaaImageView, depthImageView)
					local attachments
