local prototype = require("helpers.prototype")
local Matrix44 = require("helpers.structs.Matrix").Matrix44f
local Matrix33 = require("helpers.structs.Matrix").Matrix33f
local Vec3 = require("helpers.structs.Vec3")
local Ang3 = require("helpers.structs.Ang3")
local Rect = require("helpers.structs.Rect")
